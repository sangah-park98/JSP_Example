...
<div class="container" style="margin-top: 20px;">
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				<th style="background-color: mistyRose; vertical-align: middle;">이름</th>
				<td>
			...
			<tr>
				<th style="background-color: mistyRose; vertical-align: middle;">나이</th>
				<td>
			...
			<tr>
				<th style="background-color: mistyRose; vertical-align: middle;">이메일</th>
				<td>
